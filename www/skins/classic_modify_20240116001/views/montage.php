...
<?php
  // classic_modify_20240116001 start
  ...
  // classic_modify_20240116001 end
?>
<?php if(isset($_GET["gridMonitorId"])): // classic_modify_20240116001 start?>
  <table width="100%">
    <tr>
      <td width="<?php echo $_GET["gridRatio"]; ?>%"><?php isset($_GET["gridMonitorId"][0]) ? showMonitor($monitors[$arrMonitorIdPosition[$_GET["gridMonitorId"][0]]]) : ""; ?></td>
      <td style="width=auto; vertical-align: top;">
        <?php isset($_GET["gridMonitorId"][1]) ? showMonitor($monitors[$arrMonitorIdPosition[$_GET["gridMonitorId"][1]]]) : ""; ?>
        <?php isset($_GET["gridMonitorId"][2]) ? showMonitor($monitors[$arrMonitorIdPosition[$_GET["gridMonitorId"][2]]]) : ""; ?>
        <?php isset($_GET["gridMonitorId"][3]) ? showMonitor($monitors[$arrMonitorIdPosition[$_GET["gridMonitorId"][3]]]) : ""; ?>
      </td>
    </tr>
	</table>
<?php endif; // classic_modify_20240116001 end?>

<?php
foreach ( $monitors as $monitor ) {
  // classic_modify_20240116001 start
  if( isset($_GET["gridMonitorId"]) && 
      in_array($monitor->Id(), $_GET["gridMonitorId"])) {
    continue;
  }
  // classic_modify_20240116001 end
?>
...
?>
    <div 
      id="grid-monitor<?php echo $monitor->Id() ?>" 
      class="monitor idle"
      title="<?php echo $monitor->Id() . ' ' .$monitor->Name() ?>"
      style="width: 100%"
    >
