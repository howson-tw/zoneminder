...
?>
      <div id="gridControl">
        ...
        ?>
          <span style="white-space:nowrap;">
            ...
            <input type="number" name="gridMonitorId[]" value="<?php echo $gmId; ?>" style="width: 45px;">
          </span>
        <?php 
            endforeach;
          else:
        ...
        ?>
          <span style="white-space:nowrap;">
            ...
            <input type="number" name="gridMonitorId[]" value="<?php echo $dgmId ; ?>" style="width: 45px;">
          </span>
        <?php
            endforeach;
          endif;
        ?>
          <span style="white-space:nowrap;">
            ...
            <input type="number" name="gridMonitorId[]" value="" style="width: 45px;">
          </span>
          <span style="white-space:nowrap;">
            <label>Grid Ratio</label>
            <input type="number" name="gridRatio" step="0.1" value="<?php echo $_GET["gridRatio"]; ?>" style="width: 60px;">
          </span>
          <span style="white-space:nowrap;">
  ...
  <div id="content">
    <div id="monitors">
<?php if(isset($_GET["gridMonitorId"])): // classic_modify_20240120001 start?>
  <table width="100%">
    <tr>
...
?>
    <div 
      id="monitor<?php echo $monitor->Id() ?>" 
      class="monitor idle"
      title="<?php echo $monitor->Id() . ' ' .$monitor->Name() ?>"
      style="<?php echo $strStyle; ?>>"
    >
  <?php
    $strALink = "#";
    if($monitor->Id()==$arrGridMonitorId[0]) {
      $strALink = "/zm/index.php?view=watch&mid=".$monitor->Id();
    }
    else {
      $strALink = "/zm/index.php?view=montage&";
      ...
      array_unshift($arrGridMonitorId, $monitor->Id());
      //print_r($arrGridMonitorId);
      foreach ($arrGridMonitorId as $monitorId) {
        $strALink .= "gridMonitorId[]=".$monitorId."&";
      }
      $strALink .= "gridRatio=".$_GET["gridRatio"];
      //print(http_build_query($arrGridMonitorId));
    }
  ?>
    <a href="<?php echo $strALink; ?>">
    <div
      id="imageFeed<?php echo $monitor->Id() ?>"
      class="imageFeed"
      data-monitor-id="<?php echo $monitor->Id() ?>"
