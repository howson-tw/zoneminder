...
?>
      <div id="gridControl">
        ...
        ?>
          ...
          <input type="number" name="gridRatio" step="0.1" value="<?php echo $_GET["gridRatio"]; ?>" size="5">
  ...
  <div id="content">
    <div id="monitors">
<?php if(isset($_GET["gridMonitorId"])): // classic_modify_20240119001 start?>
  <table width="100%">
    <tr>
  ...
  ?>
<?php endif; // classic_modify_20240119001 end?>
